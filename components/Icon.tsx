...
const ICONS: Record<IconName, React.ReactElement> = {
  ...
  wand: <path strokeLinecap="round" strokeLinejoin="round" d="M9.75 3.104l-1.275 1.275a3.75 3.75 0 000 5.304L9.75 11.025l1.275-1.275a3.75 3.75 0 000-5.304L9.75 3.104zM14.25 7.5l-1.275 1.275a3.75 3.75 0 000 5.304L14.25 15.4l1.275-1.275a3.75 3.75 0 000-5.304L14.25 7.5zM18.75 11.896l-1.275 1.275a3.75 3.75 0 000 5.304L18.75 19.8l1.275-1.275a3.75 3.75 0 000-5.304L18.75 11.896zM5.25 7.5L4 8.775a3.75 3.75 0 000 5.304L5.25 15.4l1.275-1.275a3.75 3.75 0 000-5.304L5.25 7.5z" />,
  ...
  cutout: <g><path strokeLinecap="round" strokeLinejoin="round" strokeDasharray="3 3" d="M12 21a9 9 0 01-9-9 9 9 0 019-9 9 9 0 019 9 9 9 0 01-9 9z" /><path strokeLinecap="round" strokeLinejoin="round" d="M9.75 12.75l1.5-1.5-1.5-1.5m3 3l1.5-1.5-1.5-1.5m-4.5 1.5l1.5 1.5-1.5-1.5z M10.5 8.25l1.5 1.5-1.5 1.5" /></g>,
